...
public class Protocal {
    ...
    public static final int SERVER_REQUEST_BUFFER_BYTES  = MAX_BUFFER_BYTES;
    public static final int SERVER_RESPONSE_BUFFER_BYTES = MAX_BUFFER_BYTES;
    public static final int CLIENT_REQUEST_BUFFER_BYTES  = Proxy.BYTES + AnnouncementsOverview.BYTES;
    public static final int CLIENT_RESPONSE_BUFFER_BYTES = Proxy.BYTES + PostAnnouncement.BYTES;
    ...
    public class MaintainAnnouncement {
    ...
    public class AnnouncementsOverview {
    ...
    public static byte[] write(byte[] dst, int offset, int value) {
    ...
    public static byte[] write(byte[] dst, int offset, long value) {
    ...
    public static byte[] write(byte[] dst, int offset, String src) {
